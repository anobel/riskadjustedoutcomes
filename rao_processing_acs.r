...
acs <- data.frame(
  ...
  housevalue = log(as.numeric(estimate(acsd$housevalue))),
...
acsz$hoodzscore <- acsz$medianincomelog + acsz$housevalue + acsz$capincome + acsz$eduhs + acsz$educollege + acsz$empexec

save(acsd, acs, acsz, file="rao_workingdata/acs.rda")
