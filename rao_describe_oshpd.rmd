...
## Approach
- Outcome: 30 day readmission from date discharge date after index admission
- Predictors: age (10yrs), sex, Elixhauser Sum, Approach
- SES: none

```{r MEmodel44a}
me44a <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + open, data=train, family="binomial")
...
```{r MEmodel44b}
me44b <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + open + hoodzscore + ethwhite, data=train, family="binomial")
...
```{r MEmodel49a}
me49a <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + los, data=train, family="binomial") 
...
```{r MEmodel49b}
me49b <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + hoodzscore + ethwhite + los, data=train, family="binomial") 
...
## LOS: Quintile
- Outcome: 30 day readmission from date discharge date after index admission
- Predictors: age (10yrs), sex, Elixhauser Sum, LOS in top quintile
- SES: none

```{r MEmodel50a}
me50a <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + loslong5, data=train, family="binomial") 
...
```{r MEmodel50b}
me50b <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + loslong5 + hoodzscore + ethwhite + loslong5, data=train, family="binomial") 
...
## LOS: Decile
- Outcome: 30 day readmission from date discharge date after index admission
- Predictors: age (10yrs), sex, Elixhauser Sum, LOS in top decile
- SES: none

```{r MEmodel51a}
me51a <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + loslong10, data=train, family="binomial") 
...
```{r MEmodel51b}
me51b <- glm(isreadmit30dc ~ agyradmcentered + sex + elixsum + loslong10 + hoodzscore + ethwhite + loslong10, data=train, family="binomial") 
