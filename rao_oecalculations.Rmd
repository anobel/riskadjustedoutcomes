...
resPermsTable <- function(x, matsize) {
  p <- lapply(x, pvalue)
  ...
  t(ptable)
  ptable <- matrix(ptable, nrow=matsize, ncol=matsize, byrow=T)  
  rownames(ptable) = grep("^r_", names(pred), value=T)[-1]
  colnames(ptable) = grep("^r_", names(pred), value=T)[-1]
  ptable[ptable==0] <- ""
  ptable[ptable==1] <- ""
  return(kable(ptable))
}
...
results <- train %>%
  ...
  do(
    ...
    "p_approach_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + open + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_loslong5" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + loslong5 + (1|oshpd_id), data=., family="binomial"),
    "p_loslong5_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + loslong5 + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial"),
    "p_academic" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + residency + (1|oshpd_id), data=., family="binomial"),
    "p_academic_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + residency + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial"),
    "p_volumequint" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + volumequint + (1|oshpd_id), data=., family="binomial"),
    "p_volumequint_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + volumequint + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial"),
    "p_rural" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + ru + (1|oshpd_id), data=., family="binomial"),
    "p_rural_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + ru + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial"),
    "p_distance" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + km + (1|oshpd_id), data=., family="binomial"),
    "p_distance_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + km + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial")
    )
