...
- Payer: Age, Sex, Elixhauser Sum, Payer
- Payer with SES: Age, Sex, Elixhauser Sum, Payer, Diez-Roux Score, Ethnicity
- Approach: Age, Sex, Elixhauser Sum, Open/lap
- Length of Stay: Age, Sex, Elixhauser Sum, LOS in top quintile
- Academic: Age, Sex, Elixhauser Sum, if academic center
- Volume: Age, Sex, Elixhauser Sum, hospital case specific volume, by quintile
- Rural: Age, Sex, Elixhauser Sum, Patient Zip Code urban/rural by RUCA
- Distance: Age, Sex, Elixhauser Sum, Driving distance from patient to hospital for index admission
...
results <- train %>%
  ...
  do(
    ...
    # "p_base_sesplus" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + hoodzscore + ethwhite + ru + km + (1|oshpd_id), data=., family="binomial"),
    "p_payer" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + pay_cat + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_payer_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + pay_cat + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_approach" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + open + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_approach_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + open + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_loslong5" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + loslong5 + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_loslong5_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + loslong5 + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_academic" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + residency + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_academic_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + residency + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_volumequint" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + volumequint + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_volumequint_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + volumequint + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_rural" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + ru + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_rural_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + ru + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_distance" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + km + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000))),
    "p_distance_ses" = glmer(isreadmit30dc ~ agyradm + sex + elixsum + km + hoodzscore + ethwhite + (1|oshpd_id), data=., family="binomial", control=glmerControl(optimizer="bobyqa",
            optCtrl=list(maxfun=100000)))
    )
...
results <- train %>%
  ...
  do(
    ...
    "p_stayfactors" = glm(isreadmit30dc ~ agyradm + sex + open + elixsum + loslong5 + pay_cat + disp, data=., family="binomial"),
    "p_stayfactors_ses" = glm(isreadmit30dc ~ agyradm + sex + open + elixsum + loslong5 + pay_cat + disp + hoodzscore + ethwhite, data=., family="binomial"),
    "p_allfactors" = glm(isreadmit30dc ~ agyradm + sex + open + elixsum + volumequint + bedsMean + residency + loslong5 + pay_cat + disp, data=., family="binomial"),
    "p_allfactors_ses" = glm(isreadmit30dc ~ agyradm + sex + open + elixsum + volumequint + bedsMean + residency + loslong5 + pay_cat + disp + hoodzscore + ethwhite, data=., family="binomial")
  )
...
pred %>% filter(cohort=="Cystectomy" & !is.na(safetynaph)) %>%
ggplot(aes(x=reorder(oshpd_id, -p_obs), y=100*p_obs+.5, fill=safetynaph)) +
  geom_bar(stat="identity", width=0.7, position = position_dodge(width=0.2)) +
